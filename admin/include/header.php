...
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/assets/css/admin.css" media="screen" />

<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.5.7/jquery.fancybox.min.css" media="screen" />

<link href="<?php echo get_template_directory_uri(); ?>/assets/css/summernote/summernote.min.css" rel="stylesheet">
	...
	*/ ?>
	...
	<header class="header">
		<div class="container">
			...
			<div class="nav nav-topo">
				<ul>
					<?php if($page != 'login'){ ?>
						<li class="ico-right"><a href="logout.php">Sair <i class="fas fa-chevron-right"></i></a></li>
					<?php } ?>
				</ul>
			</div>
